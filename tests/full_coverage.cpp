...
double foldmul();
double foldlesstrue();
double foldlessfalse();
double foldnested();
double simplifyaddzeroleft(double);
double simplifyaddzeroright(double);
double simplifysubzero(double);
double simplifymuloneleft(double);
double simplifymuloneright(double);
double simplifymulzeroleft();
double simplifymulzeroright();
double foldiftrue(double, double);
double foldiffalse(double, double);
double keepsideeffectmulzero(double);
...
int main() {
  ...
  checkClose("foldadd", foldadd(), 5.0);
  checkClose("foldsub", foldsub(), 5.0);
  checkClose("foldmul", foldmul(), 42.0);
  checkClose("foldlesstrue", foldlesstrue(), 1.0);
  checkClose("foldlessfalse", foldlessfalse(), 0.0);
  checkClose("foldnested", foldnested(), 30.0);
  checkClose("simplifyaddzeroleft", simplifyaddzeroleft(8.0), 8.0);
  checkClose("simplifyaddzeroright", simplifyaddzeroright(8.0), 8.0);
  checkClose("simplifysubzero", simplifysubzero(8.0), 8.0);
  checkClose("simplifymuloneleft", simplifymuloneleft(8.0), 8.0);
  checkClose("simplifymuloneright", simplifymuloneright(8.0), 8.0);
  checkClose("simplifymulzeroleft", simplifymulzeroleft(), 0.0);
  checkClose("simplifymulzeroright", simplifymulzeroright(), 0.0);
  checkClose("foldiftrue", foldiftrue(11.0, 22.0), 11.0);
  checkClose("foldiffalse", foldiffalse(11.0, 22.0), 22.0);
  checkClose("keepsideeffectmulzero", keepsideeffectmulzero(13.0), 0.0);
